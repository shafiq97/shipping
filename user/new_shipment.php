...
<body>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    ...
    <a class="navbar-brand" href="track.php"><span class="fa fa-map-marker"></span> Track order</a>
    <a class="navbar-brand" href="new_shipment.php"><span class="fa fa-truck"></span> New Shipment</a>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="panel panel-info" style="margin:20px;">
          <div class="panel-heading">
            <h3 class="panel-title"><span class="fas fa-truck" aria-hidden="true"></span> Sender Details</h3>
          </div>
      ...
      <div class="col-md-6">
        ...
        <div class="panel panel-info" style="margin:20px;">
          <div class="panel-heading">
            <h3 class="panel-title"><span class="fas fa-portrait" aria-hidden="true"></span> Recipient Details</h3>
          </div>
          <div class="panel-body">
            <form>
              <div class="col-md-12 col-sm-12">
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-info" style="margin:20px;">
            <div class="panel-heading">
              <h3 class="panel-title"><span class="glyphicon glyphicon-globe" aria-hidden="true"> Consignment Info</h3>
            </div>
            <div class="panel-body">
              <form>
                <div class="col-md-12 col-sm-12">
