      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form id="adduser" action="manage_branches.php" method="POST">
            ...
            <input type="submit" class="form-control btn btn-primary" value="Proceed" name="add_branch_button">
          </form>
          ...
          <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
              <tr>
                ...
                <td>
                  <button class="btn btn-warning delete-btn" data-id="<?php echo $row["branch_id"]; ?>">
