      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form id="adduser" action="manage_customers.php" method="POST">
            ...
            <input type="submit" class="form-control btn btn-primary" value="Add User" name="add_user_button">
          </form>
          ...
          <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
              <tr>
                ...
                <td>
                  <button class="btn btn-warning delete-btn" data-id="<?php echo $row["customer_id"]; ?>">
